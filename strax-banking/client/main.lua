...
if bankMenu then
	...
	if nearBank() then
		...
		if IsControlJustPressed(1, 38) then
			...
			TriggerServerEvent('rc_bank:balance')
...
AddEventHandler('updateKonto', function(money)
	local id = PlayerId()
...
RegisterNUICallback('deposit', function(data)
	print("Bank Deposit: " .. data.amountw .. ".")
	TriggerServerEvent('rc_bank:deposit', tonumber(data.amountw))
	TriggerServerEvent('rc_bank:balance')
...
RegisterNUICallback('withdrawl', function(data)
	print("Bank Withdraw: " .. data.withdrawl .. ".")
	TriggerServerEvent('rc_bank:withdraw', tonumber(data.withdrawl))
	TriggerServerEvent('rc_bank:balance')
...
RegisterNUICallback('transfer', function(data)
	TriggerServerEvent('rc_bank:transfer', data.transferIdInput, data.transferAmountInput)
	TriggerServerEvent('rc_bank:balance')
